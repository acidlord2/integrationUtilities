<?php
 	...
 	foreach ($content['events'] as $event)
	{
		...
		if  ($state == MS_CANCEL_STATE_ID)
		{
			...
			// if (isset ($orderData['project']['meta']['href']) ? APIMS::getIdFromHref($orderData['project']['meta']['href']) == MS_PROJECT_YANDEX_VYSOTA_ID : false)
			// {
			...
			//     }
			// }
			if (isset ($orderData['project']['meta']['href']) ? APIMS::getIdFromHref($orderData['project']['meta']['href']) == MS_PROJECT_YANDEX_KOSMOS_ID : false)
			{
			...
			if (isset ($orderData['project']['meta']['href']) ? APIMS::getIdFromHref($orderData['project']['meta']['href']) == MS_PROJECT_YANDEX_ULLO_ID : false)
			{
		...
		else if ($state == MS_CONFIRMBERU_STATE_ID)
		{
			...
			if (isset ($orderData['project']['meta']['href']) ? APIMS::getIdFromHref($orderData['project']['meta']['href']) == MS_PROJECT_YANDEX_KOSMOS_ID : false)
			{
				...
				// pack order
				$packData = $ordersYandexClass->packOrder ($orderInfo);

<?php
	...
	$logger = new Log ('beru-abcasia - readytoship.log');
	...
	$ordersBeru = OrdersBeru::getOrders (BERU_API_ABCASIA_CAMPAIGN, $filters);
	...
	foreach ($ordersBeru as $orderBeru)
	{
		...
		OrdersBeru::packOrder (BERU_API_ABCASIA_CAMPAIGN, $orderBeru['id'], $orderBeru['delivery']['shipments'][0]['id'], $boxes);
		...
		OrdersBeru::updateOrderStatus (BERU_API_ABCASIA_CAMPAIGN, $orderBeru['id'], $statusData);
		$orderLabels = OrdersBeru::getOrdersLebels (BERU_API_ABCASIA_CAMPAIGN, $orderBeru['id']);

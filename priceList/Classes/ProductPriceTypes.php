...
class ProductPriceTypes
{
	...
	public function __construct()
	{
		...
		$this->logger->write(__LINE__ . ' ' . __METHOD__ . ' Initializing ProductPriceTypes class');
		...
		$this->logger->write(__LINE__ . ' ' . __METHOD__ . ' Loaded product price types: ' . json_encode($this->productPriceTypes, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE));
	}	

...
class OrdersBeru2
{
    ...
    public static function getOrders($campaign, $filters)
    {
		...
		require_once($_SERVER['DOCUMENT_ROOT'] . '/classes/apiBeru2.php');
		...
		while ($page <= $maxpage) { 
			...
			APIBeru2::getBeruData ($campaign, $service_url, $ordersJson, $ordersArray);
    ...
    public static function packOrder($campaign, $orderId, $shipmentId, $boxes)
    {
		...
		APIBeru2::putBeruData ($campaign, $service_url, $boxes, $returnJson, $return);
    ...
    public static function updateOrderStatus($campaign, $orderId, $data)
    {
		...
		APIBeru2::putBeruData ($campaign, $service_url, $data, $returnJson, $return);
    ...
    public static function getOrdersLebels($campaign, $orderId)
    {
		...
		APIBeru2::getBeruData ($campaign, $service_url, $returnJson, $return);

...
class APIMS
{
    ...
    public static function postMSDataBlob($service_url, $postdata)
	{
		require_once($_SERVER['DOCUMENT_ROOT'] . '/config.php');
		require_once($_SERVER['DOCUMENT_ROOT'] . '/classes/db.php');
		require_once($_SERVER['DOCUMENT_ROOT'] . '/classes/log.php');
		...
		{
		    $logger->write(__LINE__ . ' postMSDataBlob Error No: ' . curl_errno($curl_order) . ' | Error msg: ' . curl_error($curl_order));
		}

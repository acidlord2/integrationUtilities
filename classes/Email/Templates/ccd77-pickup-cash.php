...
function getPickupCashEmailTemplate($orderNumber, $orderAmount) {
    ...
    $body .= "Часы работы:\n";
    $body .= "{$workingHours}\n\n";
    $body .= "ОПЛАТА НАЛИЧНЫМИ ПРИ ПОЛУЧЕНИИ\n";
    $body .= "Сумма к оплате: {$formattedAmount} ₽\n\n";
    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="payment-block">
                <div class="payment-title">💰 Оплата наличными при получении</div>
                <div class="payment-amount">{$formattedAmount} ₽</div>
                <div class="payment-text">Подготовьте точную сумму для оплаты заказа</div>
            </div>

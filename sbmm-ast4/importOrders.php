<?php
	...
	$log = new Log('sbmm-ast4 - importOrders.log');
	
	$sbmmOrdersClass = new \Classes\Sbermegamarket\Order(SBMM_SHOP_AST4);
	...
	foreach($shipments['shipments'] as $shipment)
	{
		...
		if (isset($shipment['items'])) {
			...
			$orderData = array(
				...
				'organization' => array (
					'meta' => array (
						'href' => MS_API_BASE_URL . MS_API_VERSION_1_2 . MS_API_ORGANIZATION . '/' . MS_APOLLON_ID,
						'type' => 'organization',
						'mediaType' => 'application/json'
					)
				),

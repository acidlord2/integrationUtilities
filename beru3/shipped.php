<?php
	...
	while (true) {
	    ...
	    $service_url = MS_API_BASE_URL . MS_API_VERSION_1_2 . MS_API_CUSTOMERORDER . '/?filter=deliveryPlannedMoment' . urlencode ('>') . '=' . date('Y-m-d', strtotime("now")) . ';state=' . MS_SHIPPED_MP_STATE . ';agent=' . MS_BERU_AGENT . ';organization=' . MS_ULLO . '&limit=100&offset=' . $page;

...
//	require_once($_SERVER['DOCUMENT_ROOT'] . '/classes/orders.php');
	...
	$log = new Log ('ozonKaoriDbs - getNewOrders.log');
	$ordersOzonClass = new OrdersOzon('kaori');
	
	$ordersOzon = $ordersOzonClass->findOrders(date ('Y-m-d', strtotime('-1 day')) . 'T00:00:00Z', date ('Y-m-d', strtotime('now')) . 'T23:59:59Z', 'awaiting_packaging', OZON_WEARHOUSE2_ID);

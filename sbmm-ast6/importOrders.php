<?php
	...
	$log = new Log('sbmm-ast6 - importOrders.log');
	
	$sbmmOrdersClass = new \Classes\Sbermegamarket\Order(SBMM_SHOP_AST6);
	...
	foreach($shipments['shipments'] as $shipment)
	{
		...
		if (isset($shipment['items'])) {
			...
			$orderData = array(
				...
				'organization' => array (
					'meta' => array (
						'href' => MS_API_BASE_URL . MS_API_VERSION_1_2 . MS_API_ORGANIZATION . '/' . MS_VYSOTA_ID,
						'type' => 'organization',
						'mediaType' => 'application/json'
					)
				),

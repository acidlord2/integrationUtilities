<?php
	...
	$log = new Log('sbmm-ast6 - packing.log'); //just passed the file name as file_name.log
	...
	foreach ($data['data']['shipments'] as $shipment)
	{
	    ...
	    $order_data['organization'] = array('meta' => APIMS::createMeta(MS_API_BASE_URL . MS_API_VERSION_1_2 . MS_API_ORGANIZATION . '/' . MS_VYSOTA_ID, 'organization'));
	    ...
	    $order_data['project'] = array('meta' => APIMS::createMeta(MS_API_BASE_URL . MS_API_VERSION_1_2 . MS_API_PROJECT . '/' . MS_PROJECT_SBMM_AST6_ID, 'project'));

<?php
	...
	$log = new Log ('ozonKaoriDbs2 - UpdateProducts.log');
	...
	foreach ($productsMS as $key => $productMS)
	{
		...
		//array_push ($stocks['stocks'], array ('offer_id' => $productMS['code'], 'stock' => ($price == 0 ? 0 : $quantity), 'warehouse_id' => OZON_WEARHOUSE3_ID));
		array_push ($stocks['stocks'], array ('offer_id' => $productMS['code'], 'stock' => 0, 'warehouse_id' => OZON_WEARHOUSE3_ID));

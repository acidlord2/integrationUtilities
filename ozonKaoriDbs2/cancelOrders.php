<?php
	...
	$ordersOzon = $ordersOzonClass->findOrders(date('Y-m-d', strtotime('now -' . $paramPeriod . ' days')) . 'T00:00:00Z', date ('Y-m-d', strtotime('now')) . 'T23:59:59Z', 'cancelled', OZON_WEARHOUSE3_ID);

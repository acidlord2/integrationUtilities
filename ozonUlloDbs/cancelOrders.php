<?php
	...
	if (isset($_GET['period']))
		...
		$ordersOzon = $ordersOzonClass->findOrders(date('Y-m-d', strtotime('now -' . $paramPeriod . ' days')) . 'T00:00:00Z', date ('Y-m-d', strtotime('now')) . 'T23:59:59Z', 'cancelled', OZON_ULLO_WEARHOUSE1_ID);

<?php
	...
	$logger = new Log('beru-aruba-cart.log'); //just passed the file name as file_name.log
	...
	$logger->write("01 data - " . json_encode ($data, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE));

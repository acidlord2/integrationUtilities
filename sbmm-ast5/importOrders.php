<?php
	...
	$log = new Log('sbmm-ast5 - importOrders.log');
	...
	foreach($shipments['shipments'] as $shipment)
	{
		...
		if (isset($shipment['items'])) {
			...
			$orderData = array(
				...
				'organization' => array (
					'meta' => array (
						'href' => MS_API_BASE_URL . MS_API_VERSION_1_2 . MS_API_ORGANIZATION . '/' . MS_PLUTON_ID,
						'type' => 'organization',
						'mediaType' => 'application/json'
					)
				),

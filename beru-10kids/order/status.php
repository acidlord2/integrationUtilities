<?php
	...
	$logger = new Log('beru-10kids-status.log'); //just passed the file name as file_name.log
	...
	$logger->write("06 return - " . json_encode ($return, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE));
